    ...
    <Box sx={{ display: 'flex' , justifyContent: 'space-around', alignItems: 'center', width:600, marginTop: 7, marginBottom: 2, boxShadow: 1, borderRadius: 2, padding: 3}}>
     ...
     <Box>
      <Box sx={{padding: 1}}>
        ...
        <Select sx={{height:30}} label="Choose Office:" value={office} onChange={(e)=>setOffice(e.target.value)}>
        ...
        <Select sx={{height:30}} type='text' name='status' value={status} onChange={(e)=>setStatus(e.target.value)}>
          <MenuItem hidden>Choose status:</MenuItem>
